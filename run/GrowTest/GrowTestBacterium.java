...
/**
 */
public class GrowTestBacterium extends BSimCapsuleBacterium {

    //function you call when you want to make a new bacterium object
    public GrowTestBacterium(BSim sim, Vector3d px1, Vector3d px2){
    ...
    public GrowTestBacterium divide() {
        ...
        GrowTestBacterium child = new GrowTestBacterium(sim, x1_child, new Vector3d(this.x2));
